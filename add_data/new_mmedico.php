                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="page-title-box d-flex align-items-center justify-content-between">
                                <h4 class="mb-0 font-size-18">Almacén de Materiales Médicos <i
                    ...
                    <div class="row">
                        <div class="col-xl-12">
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="card-title">Nuevo Material Médico</h4>
                                    <p class="card-subtitle mb-4">Rellenar los datos correctamente para poder guardar.</p>
                                    <form class="needs-validation" novalidate action="../processes/guardar_mmedico.php" method="POST" id="mmedicamentoForm">
                                        <div class="form-row">
                                        ...
                                        <a href="../view/almacen_mmedico.php" class="btn btn-danger waves-effect waves-light">Cancelar</a>
                                    </form>
                                    <script>
                                        // Función para validar el formulario antes de enviarlo
                                        document.getElementById('mmedicamentoForm').addEventListener('submit', function(event) {
                                            var form = this;
                                            var isValid = true;
