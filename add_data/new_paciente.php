                                ...
                                <div class="card-body">
                                    ...
                                    <form class="needs-validation" novalidate action="../processes/guardar_paciente.php" method="POST" id="pacienteForm">
                                        <div class="form-row">
                                            ...
                                            <div class="col-md-3 mb-3">
                                                ...
                                                <input type="text" class="form-control" id="nombres" name="nombres" onkeypress="return check(event)" required>
                                            </div>
                                            <div class="col-md-3 mb-3">
                                                <label for="validationTooltip01">Apellido Paterno</label>
                                                <input type="text" class="form-control" id="apellidoPaterno" name="apellido_paterno" onkeypress="return check(event)" required>
                                            </div>
                                            <div class="col-md-3 mb-3">
                                                <label for="validationTooltip01">Apellido Materno</label>
                                                <input type="text" class="form-control" id="apellidoMaterno" name="apellido_materno" onkeypress="return check(event)" required>
                                            </div>
                                        </div>
                                        <div class="form-row">
                                    ...
                                    <script>
                                        ...
                                        document.getElementById('pacienteForm').addEventListener('submit', function(event) {
                                            ...
                                            if (document.getElementsByName('programa_estudios').value == "") {
                                                isValid = false;
                                                document.getElementsByName('programa_estudios').classList.add('is-invalid');
                                            }
