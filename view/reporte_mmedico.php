...
<body>
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="page-title-box d-flex align-items-center justify-content-between">
                                <h4 class="mb-0 font-size-18">Reporte de Material Médico</h4>

                                <div class="page-title-right">
                                    <ol class="breadcrumb m-0">
                                        <li class="breadcrumb-item"><a href="javascript: void(0);">SISTOPI</a></li>
                                        <li class="breadcrumb-item active">Reporte de Material Médico</li>
                                    </ol>
                                </div>
    ...
    LEFT JOIN 
        atencion_insumos ai 
        ON ai.insumo_medico = mm.id AND ai.tipo = 2
    WHERE 
        mm.estado = 1
    GROUP BY 
...
";
                                            ...
                                            <?php else: ?>
                                                <tr>
                                                    <td colspan="5" class="text-center">No se encontraron materiales médicos en el almacén.</td>
                                                </tr>
                                            <?php endif; ?>
                                        </tbody>
                                    </table>
